...
function Blog(props) {
  ...
  return (
    <div>
      ...
      <p>
        The current user is {props.currUser === null ? (<b>N/A</b>) : props.currUser.firstName}
      </p>
      <p>
        The current user does {props.blogPermission ? null : (<b>not</b>)} have blogging permissions.
      </p>
    </div>
  );
}
